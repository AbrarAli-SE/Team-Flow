...
export function MessagesList() {
  ...
  // ----------------------------------------
  // FIX #1 — state updates inside effect → wrap in startTransition
  // ----------------------------------------
  useEffect(() => {
  ...
  const handleScroll = () => {
    ...
    // FIX #2 — wrap setState inside transition
    startTransition(() => {
  ...
  return (
    <div className="relative h-full">
      ...
      {isFetchingNextPage && (
        <div className="pointer-events-none absolute top-0 left-0 right-0 z-20 flex justify-center items-center py-2">
